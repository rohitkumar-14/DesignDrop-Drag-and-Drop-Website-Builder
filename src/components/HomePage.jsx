        ...
        <nav class="navbar container">
          ...
          <div class="menu" id="menu">
            <ul class="menu-inner">
              ...
              <NavLink to={"/builder"}><button class="btn btn-primary" tabIndex="-1">Discover</button></NavLink>
      ...
      <main class="main">
        <section class="section banner banner-section">
          <div class="container banner-column">
            <img class="banner-image" src={heroImg} alt="banner" />
            <div class="banner-inner">
              <h1 class="heading-xl">Build Beautiful Sites Instantly</h1>
              <h4 class="heading-xs">with Our Drag-and-Drop Tool</h4>
              <p class="paragraph">
                Unleash your creativity with our powerful and intuitive
                drag-and-drop website builder. Whether you're a seasoned
                designer or a complete beginner, our tool empowers you to build
                beautiful, responsive websites effortlessly. Choose from a
                variety of drag and drop components, and customize every element
                to match your vision. Say goodbye to complex coding and hello to
                simplicity and elegance in web design.
              </p>
              
                <NavLink to="/builder"><button class="btn btn-darken btn-inline">
                  Our Tool <i class="fa-solid fa-arrow-right"></i> </button>
                </NavLink>
            ...
            <div class="container d-flex justify-content-center align-items-center banner-column">
              ...
              <form>
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-primary" tabIndex="-1" onClick={()=>alert("Message sent successfully!")}>
                    Send message
                  </button>
                </div>
              </form>
        ...
        <h1 class="heading-xss">Developed by Rohit Kumar</h1>
      </main>
    </>
  );
};
